...
#include "monocular_pose_estimator/monocular_pose_estimator_usb_cam.h"
...
void MPENode::run() {
                        ...
                        // valid pose was found).
  {
    ...
    predicted_pose_.header.frame_id = "mpe_frame";
    ...
    auto ned_quat = Eigen::Quaterniond(0.0, -1.0 / std::sqrt(2), 1.0 / std::sqrt(2), 0.0);
